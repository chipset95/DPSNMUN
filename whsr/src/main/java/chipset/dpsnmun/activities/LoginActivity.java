...
import static chipset.dpsnmun.resources.Constants.KEY_ADMIN;
import static chipset.dpsnmun.resources.Constants.KEY_LOGIN_COUNT;
import static chipset.dpsnmun.resources.Constants.KEY_NO_LOGIN;
/*
 * Developer: chipset
 * Package : chipset.dpsnmun.activities
 * Project : WHSR
                                ...
                                if (loginCount >= 0 && loginCount < 5) {
                                    if (noLogin) {
                                        ...
                                        if (currentTime.before(reqTime)) {
                                            ...
                                            progressDialog.dismiss();
                                            startActivity(new Intent(LoginActivity.this, chipset.dpsnmun.activities.MainActivity.class));
                                            finish();
                                        }
                                    } else {
                                        loginCount++;
